...
const PATCH_NOTES = {
    ...
    "versions": {
        "v31": {
            ...
            "title": "more memories!!",
            "changes": [
                "new memories added (i use hehe too much)"
            ]
        },
        "v30": {
        ...
        "v22": {
            ...
            "changes": [
                "memo memo memory",
                "but i dont just want a memory of you",
                "i want you",
                "i want us",
                "forever and always",
            ]
        ...
        "v21": {
            "date": "July 25, 2026",
            "title": " hehe right after midnight",
            "changes": [
                "see even more memories!",
            ]
        },
        "v20": {
            "date": "July 24, 2026",
            "title": "this one is after midnight oopsie",
            "changes": [
                "see memories and comments!",
            ]
        },
        "v19": {
            "date": "July 22, 2026",
            "title": "hehe it is before midnight",
            "changes": [
                "new memories and comment responses!",
            ]
        },
        "v18": {
            "date": "July 22, 2026",
            "title": "MEW MEMORIS",
            "changes": [
                "see new memories and responses to ur comments!!",
                "if you dont see try openin incog i fix soon",
            ]
        },
        "v17": {
            "date": "July 21, 2026",
            "title": "WE HIT PITTSBUGH",
            "changes": [
                "see memmies hehe",
            ]
        },
        ...
        "v15": {
            "date": "July 17, 2026",
            "title": "more memoriesss",
            "changes": [
                "hehe we stopped right before a trip yesterday"
            ]
        },
        "v14": {
            "date": "July 15, 2026",
            "title": "100 days of memories",
            "changes": [
                "check out the new buttons! sorry for delay",
                "and new memories ofc"
            ]
        },
        "v13": {
            "date": "July 13, 2026",
            "title": "is before midnight hehe",
            "changes": [
                "more memories!!",
                "i responded to ur old memories. I will make a more intuitive interface for you to see them soon",
                "ik its a pain in ass lol"
            ]
        },
        "v12": {
            "date": "July 13, 2026",
            "title": "memomemomemories",
            "changes": [
                "see title wheee"
            ]
        },
        ...
        "v10": {
            ...
            "title": "more memories!!",
            "changes": [
                "and still spin the roulette if u wanna hehe",
            ]
        },
        "v9": {
            "date": "July 7, 2026",
            "title": "also in honor of our trip",
            "changes": [
                "the slot machine got some new additions, spin and sned me screenshot!!"
            ]
        },
        "v8": {
            "date": "July 1, 2026",
            "title": "in honor of our trip",
            "changes": [
                "go the the page with the heart, see it for yourself, and send me a screenshot :D"
            ]
        },
        "v7": {
            "date": "June 30, 2026",
